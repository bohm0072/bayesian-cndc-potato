...
run_fits <- function(){
  ...
  m0010 <- brms_fit(data=data_cndc,
                    ...
                    priors=c(set_prior("normal(8.0,1.0)", class = "sd", nlpar = "Bmax", group = "index"),
                             set_prior("normal(1.0,0.1)", class = "sd", nlpar = "Si", group = "index"),
                             set_prior("normal(0.20,0.01)", nlpar = "alpha1", class = "sd", group ="location"),
                             set_prior("normal(0.06,0.01)", nlpar = "alpha2", class = "sd", group ="location"),
                             set_prior("normal(0.05,0.01)", nlpar = "alpha1", class = "sd", group ="location:variety"),
                             set_prior("normal(0.03,0.01)", nlpar = "alpha2", class = "sd", group ="location:variety"),
                             set_prior("normal(8.0,2.0)", nlpar = "Bmax", lb = 1),
                             set_prior("normal(6.0,0.1)", nlpar = "Si", lb = 0),
                             set_prior("normal(5.2,0.1)", nlpar = "alpha1", lb = 0),
                             set_prior("normal(0.36,0.01)", nlpar = "alpha2", lb = 0, ub = 1),
