...
run_fits <- function(){
  ...
  #                              nl = T),
  #                   priors=c(set_prior("normal(7.0,0.4)", class = "sd", nlpar = "Bmax"),
  #                            set_prior("normal(4.0,0.3)", class = "sd", nlpar = "Si"),
  #                            set_prior("normal(0.20,0.01)", nlpar = "alpha1", class = "sd", group ="location:variety"),
  #                            set_prior("normal(0.12,0.01)", nlpar = "alpha2", class = "sd", group ="location:variety"),
  #                            set_prior("normal(12.0,0.1)", nlpar = "Bmax", lb = 1),
  #                            set_prior("normal(5.0,0.01)", nlpar = "Si", lb = 0),
  #                            set_prior("normal(5.0,0.01)", nlpar = "alpha1", lb = 0),
  #                            set_prior("normal(0.33,0.01)", nlpar = "alpha2", lb = 0, ub = 1),
