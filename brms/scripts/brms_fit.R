...
run_fits <- function(){
  ...
  m0010 <- brms_fit(data=data_cndc,
                    ...
                    formula=bf(W ~ fmin(Bmax + Si * (N - (alpha1*(Bmax^(-alpha2)))), Bmax),
                               ...
                               nl = T),
                    priors=c(set_prior("normal(8.0,1.0)", class = "sd", nlpar = "Bmax", group = "index"),
                             set_prior("normal(1.0,0.1)", class = "sd", nlpar = "Si", group = "index"),
                             set_prior("normal(0.20,0.04)", nlpar = "alpha1", class = "sd", group ="location"),
                             set_prior("normal(0.035,0.01)", nlpar = "alpha2", class = "sd", group ="location"),
                             set_prior("normal(0.10,0.02)", nlpar = "alpha1", class = "sd", group ="location:variety"),
                             set_prior("normal(0.035,0.01)", nlpar = "alpha2", class = "sd", group ="location:variety"),
                             set_prior("normal(8.0,2.0)", nlpar = "Bmax", lb = 1),
                             set_prior("normal(6.0,0.1)", nlpar = "Si", lb = 0),
                             set_prior("normal(5.3,0.2)", nlpar = "alpha1", lb = 0),
                             set_prior("normal(0.35,0.035)", nlpar = "alpha2", lb = 0, ub = 1),
